...
import (
	"Distream/src/dataserial"
	"Distream/src/transport"
	"errors"
	"net"
	"reflect"
)
...
func NewClient(id int, conn net.Conn) *RPCClient {
	return &RPCClient{id, conn}
}

// assign remote exposed method to fPtr
